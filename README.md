...
> Short Talk at [Leipzig Gophers](https://golangleipzig.space), [2020-10-16](https://golangleipzig.space/posts/meetup-13-wrapup/), 1900 CEST (remote)
...
The (now [defunkt](https://blog.kobol.io/2021/08/25/we-are-pulling-the-plug/))
...
plus low end 16T HDDs we can get 1PB for `64 disks * $250` + `13 boards * $240`
for $19120. 60PB then would roughly equate to `60 * $20000`, or $1,200,000. Off-the-self, in 2023, for $20,000,000 you can get an [Exabyte](https://www.backblaze.com/blog/what-is-an-exabyte/).
